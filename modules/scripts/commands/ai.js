...
module.exports.config = {
  name: "ai", author: "Sethdico", version: "16.95", category: "AI", description: "Advanced Assistant.", adminOnly: false, usePrefix: false, cooldown: 0, 
};
  ...
  try {
    ...
    const response = await fetchWithRetry(async () => {
        ...
        const body = {
          ...
          messages: [{ role: "system", content: identityPrompt }, { role: "user", content: finalInput }],
          stream: false
        };
